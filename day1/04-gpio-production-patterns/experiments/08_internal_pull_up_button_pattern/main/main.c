...
static const char *TAG = "internal_pullup";
...
void app_main(void)
{
    ...
    ESP_LOGI(TAG, "Internal pull-up button experiment started");
    ESP_LOGI(TAG, "Button released = HIGH");
    ESP_LOGI(TAG, "Button pressed  = LOW");
